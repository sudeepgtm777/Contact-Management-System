...
const EditContactPage = () => {
      ...
      try {
        ...
        if (data && data.data && data.data.contact) {
          ...
          setFormData({
            ...
            user_logo: contact.user_logo || 'default.jpg',
            user_email: contact.user_email || '',
            user_phone: contact.user_phone || '',
            property_type: contact.property_type || 'Residential',
            properties: contact.properties || '',
            company: contact.company || '',
          });
          setPhone(contact.user_phone || '+977');
        } else {
  ...
  if (fetching) return <p className='text-center mt-10'>Loading contact...</p>;
